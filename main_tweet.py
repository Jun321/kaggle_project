...
def main():
    ...
    vectorizers = [tfidf1,tfidf3,tfidf4,tfidf5,tfidf6, tfidf7,tfidf8,tfidf9,tfidf10,tfidf11,tfidf12,tfidf13]
    ...
    if cv_split == 0:
        ...
        y = y[:int(np.round(len(t['tweet'].tolist())*(1-cv_split)))]   
    ...
    for tfid in vectorizers:    
        ...
        for clf, use_lsa in zip(clfs,lsa_classifier):            
            if use_lsa == 1:
                ...
                t_matrix = u.create_t_matrix(fac.codes)
